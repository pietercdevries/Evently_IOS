//
//  AWSS3ManagerEventImages.swift
//  Evently
//
//  Created by Pieter De Vries on 1/20/20.
...
class AWSS3ManagerEventImages {
    
    static let shared = AWSS3ManagerEventImages()
    private init () { }
    let bucketName = "evently-event-images"
    
    // Upload image using UIImage object
    func uploadImage(image: UIImage, imageName: String?, progress: progressBlock?, completion: completionBlock?) {
